...
programa:
	...
	JG Imprimir_Primero_Es_Mayor		;SI NUM1>NUM2 DADO QUE LA RESTA DA UN NUMERO NEGATIVO 
	JL Imprimir_Segundo_Es_Mayor		;SI NUM1<NUM2 DADO QUE LA RESTA DA UN NUMERO POSITIVO 
